 ...
 */
class LearnerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function add(Learner $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Learner $entity, bool $flush = true): void
    {
